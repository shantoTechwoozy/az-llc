        ...
        <section className="bg-zinc-50 overflow-hidden py-12 lg:py-24">
            <div className="max-w-screen-xl 2xl:max-w-screen-3xl px-8 md:px-12 mx-auto space-y-24">
                ...
                <div className="text-center space-y-4 mb-5">
                    ...
                    <p className="text-2xl lg:text-6xl font-semibold bg-clip-text text-transparent bg-gradient-to-r from-green-400 via-blue-500 to-blue-600">Let&apos;s Get Started</p>
                ...
                <div className="flex flex-col sm:flex-row mx-auto space-y-6 sm:space-y-0 sm:space-x-6">
                    {/* Card 1: Appointment */}
                    <div className="relative flex-1 bg-white rounded-xl shadow-lg p-6 flex flex-col items-center space-y-4 transition-transform transform hover:scale-110 hover:rotate-3 hover:-translate-y-6 duration-500 ease-in-out max-w-xs sm:max-w-sm md:max-w-md">
                        <FaCalendarAlt className="text-4xl text-blue-500 transition-transform transform hover:scale-125 duration-500 ease-in-out" />
                        <h3 className="text-xl text-center font-semibold text-gray-800">Set an Appointment</h3>
                    ...
                    <div className="relative flex-1 bg-white rounded-xl shadow-lg p-6 flex flex-col items-center space-y-4 transition-transform transform hover:scale-110 hover:rotate-3 hover:-translate-y-6 duration-500 ease-in-out max-w-xs sm:max-w-sm md:max-w-md">
                        ...
                        <h3 className="text-xl text-center font-semibold text-gray-800">We Accept Referrals</h3>
                        <p className="text-center text-gray-600">
                    ...
                    <div className="relative flex-1 bg-white rounded-xl shadow-lg p-6 flex flex-col items-center space-y-4 transition-transform transform hover:scale-110 hover:rotate-3 hover:-translate-y-6 duration-500 ease-in-out max-w-xs sm:max-w-sm md:max-w-md">
                        ...
                        <h3 className="text-xl text-center font-semibold text-gray-800">Meet Our Caregivers</h3>
                        <p className="text-center text-gray-600">
